...
## STAGE 2
Donat un listing classificat com asset al Stage1:
- No infracció: INFRINGEMENT_DISCARDED
- Potencial infracció: INFRINGEMENT_VALIDATED, INFRINGEMENT_CONFIRMED, ONFIRMATION_ON_HOLD, INFRINGEMENT_VERIFIED, CONFIRMATION_DISCARDED

Proposta: Classificació binaria combinant regressió logística amb un senyal de similarity. Igual que al Stage1 utilitzo TF-IDF + LogisticRegression per simplicitat i velocitat. A més, afegeixo una comprovació de similitud amb listings positius coneguts per reforçar
la detecció quan un títol és molt semblant a altres.
